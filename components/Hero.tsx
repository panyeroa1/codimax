...
const DrawingTransformation = ({ 
  ...
  return (
    <div 
      className="absolute transition-all duration-1000 ease-in-out z-0 pointer-events-none drawing-card"
      {...{ style: { '--card-top': y, '--card-left': x, '--card-rotation': `${rotation}deg` } as React.CSSProperties }}
    >
